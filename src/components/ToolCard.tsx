...
import { ExternalLink, ChevronUp, Sparkles, Zap, CheckCircle2, ShieldCheck } from 'lucide-react';
...
export const ToolCard: React.FC<ToolCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {tool.is_featured && (
        <div className="absolute -top-3 left-5 inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-gradient-to-r from-amber-400 to-orange-400 text-zinc-950 shadow-md shadow-amber-500/20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {tool.is_featured && (
                  <span title="Verified & Paddle Featured Upgrade">
      ...
      {/* Footer Meta: Category, Pricing & Link */}
